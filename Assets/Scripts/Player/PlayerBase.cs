        ...
        public void RpcSetTeam(string teamName, uint playerId)
        {
            ...
            switch (Team)
            {
                case Team.Suicidials:
                    ...
                    skin.transform.localScale = new Vector3(0.8f, 0.4f, 1); //Because fuck you.
                ...
                case Team.Rescuers:
                    ...
                    skin2.transform.localPosition = new Vector3(0,0,0);
                    skin2.transform.localScale = new Vector3(0.8f, 0.4f, 1); //Because fuck you.
